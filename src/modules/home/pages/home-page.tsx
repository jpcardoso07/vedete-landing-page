      ...
      <div className="flex flex-col-reverse lg:flex-row items-center justify-between gap-12 w-full max-w-[1300px]">
        ...
        >
          <img
            src={Refri1}
            alt="Refri 1"
            className="w-[50%] xl:w-[60%] h-fit pt-[10%] xl:pt-[12%] transition-transform duration-500 ease-out hover:scale-110"
          />
          <img
            src={Refri2}
            alt="Refri 2"
            className="w-[60%] xl:w-[72%] transition-transform duration-500 ease-out hover:scale-110"
          />
        </div>
